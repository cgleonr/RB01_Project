...
# Introduction
Diet plays a crucial role in influencing health and longevity, with numerous studies emphasizing the importance of nutrition in extending life expectancy. A balanced intake of macronutrients—such as carbohydrates, fats, and proteins—has been consistently linked to improved health outcomes and increased lifespan. However, the relationship between dietary intake and life expectancy remains complex, as it is influenced by a variety of factors beyond nutrition, including healthcare access, socio-economic conditions, and lifestyle choices. 
...
This report shows limitations that are severalfold. While diet is a key factor, other elements like healthcare, food accessibility, and socio-economic conditions also affect longevity. The quality and availability of data may also vary between countries, potentially influencing the results. 


# Theoretical Focus
Understanding the nutritional drivers of life expectancy requires examining the influence of nutrition and dietary patterns. Research highlights the importance of health-related behaviors—such as maintaining a healthy BMI, regular physical activity, and a nutritious diet—in extending life expectancy. For instance, Li et al. (2018) found that adopting these factors could extend life by up to 14 years for women and 12 years for men compared to those with higher-risk behaviors. 
...
Macronutrient intake, which includes proteins, carbohydrates, and fats, plays a significant role in public health. While protein intake remains stable globally, carbohydrate and fat consumption vary more widely across regions, reflecting economic and cultural differences (Lieberman et al., 2020). The WHO recommends limiting fat to 30% of total energy intake, prioritizing whole grains, vegetables, and fruits in diets—key elements of many healthful dietary patterns. 
...
### Dietary Uncertainty and Global Health Guidelines 
...
The dataset contains 32,910 rows and 15 columns and is formatted in long format. It spans the period from 2010 to 2022 and includes key variables such as: 
...
This dataset is valuable for analyzing patterns in nutritional intake and how they relate to health outcomes such as life expectancy across different geographic regions. The organized structure of the dataset allows for longitudinal and cross-country comparisons of dietary patterns and nutritional trends.
...
### Model:
#### Visualizations:
Visualizations were created using the ggplot2 package in R, while ensuring that all plots were color-blind safe. Whenever possible, interactive visualizations were produced to enhance user interaction and provide additional insights.
...
### Geographical Patterns of Life Expectancy and Nutritional Intake
...
Plot 7 provides a more detailed breakdown of the ratio between animal and vegetal products consumed in each country. A lower ratio indicates that the consumption of animal and vegetal products is relatively equal, while a higher ratio suggests a greater difference between the two, with either animal or vegetal products dominating the diet.
...
Similar to Plot 9, Plot 10 illustrates the ratio of animal to plant-based protein intake across the top, middle, and bottom country categories. Interestingly, across all countries, the ratios are relatively volatile, with noticeable variation over the years.
...
### Datasets
FAOSTAT data on consumption per capita: </br>
https://www.fao.org/faostat/en/#data/FBS 

Life expectancy: </br>
https://www.who.int/data/gho/data/indicators/indicator-details/GHO/life-expectancy-at-birth-(years) 

Country Capital Lat/Lon list: </br>
